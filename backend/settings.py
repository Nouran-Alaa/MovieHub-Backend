...
INSTALLED_APPS = [
    ...
    'rest_framework_simplejwt.token_blacklist',  # Add this for token blacklist
    'corsheaders',
    'drf_yasg',
    'movies',
]
...
# Allow all origins in production for easier setup
...
# Logging configuration (helpful for debugging on Railway)
LOGGING = {
    'version': 1,
